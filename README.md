...
```bash
python nerfuncertainty/scripts/save_noisy_images.py --input_folder <path to where images to modify are> --output_folder <path where to save new images> --operation <'noise' or 'blur'> --std_dev <scale of gaussian noise (float)> --kernel_size <size of blur kernel (int)> 
```
